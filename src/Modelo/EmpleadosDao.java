...
public class EmpleadosDao {
    ...
    //Metodo para actualizar empleado
     ...
     String sql = "UPDATE empleados SET nombre=?, contraseña=?, idPerfil=? WHERE idempleados=?";//sentencia sql
     try{
                     con =cn.getConnection();
    ...
    public boolean RegistrarEmpleado(Empleados p){ 
      String sql = "INSERT INTO empleados (nombre, contraseña, fechaCreacion, idPerfil) VALUES (?,?,?,?)";
        try{
          con = cn.getConnection();
          ps = con.prepareStatement(sql);
    ...
    public Empleados seleccionarEmpleado(String nombre, int id){
        ...
        try{
         ...
         if(rs.next()){
             ...
             cl.setIdPerfil(rs.getInt("idPerfil"));
         }
        }catch(SQLException e){
         System.out.println(e.toString());
        }finally{
    ...
    public List listarEmpleados(){
       ...
       try{
        ...
        while(rs.next()){
         ...
         e.setIdPerfil(rs.getInt("idPerfil"));
     ...
     public boolean perfilUsado(int idproveedor){
       String sql = "SELECT * FROM empleados WHERE idPerfil=?";
       boolean bandera=false;
       try{
        con = cn.getConnection();
        ps = con.prepareStatement(sql);
    ...
    //mmetodo para verificar si se ha repetido algunn cliente
     public boolean EmpleRepetidaActualizar(Empleados cl){
        ...
        try{
         ...
         rs=ps.executeQuery();
            while(rs.next()){
             int codigo =rs.getInt("idempleados");
             String nombre = rs.getString("nombre");
             if(cl.getNombre().equals(nombre) && cl.getId()!= codigo){
                 bandera=true;
             }
