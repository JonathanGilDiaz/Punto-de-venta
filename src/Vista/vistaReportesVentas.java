     ...
     public java.util.Date StringADate(String cambiar) { //Este metodo te transforma un String a date (dia)
       ...
       SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        ...
        for (int i = lsVentas.size()-1; i>=0; i--) {//las vaciamos de la mas reciente a la mas vieja
           ...
           descuento = descuento + lsVentas.get(i).getDescuentos();
           ...
           saldo = saldo + lsVentas.get(i).getSaldo();
           for(int k = 0; k<lsE.size();k++){
               if(lsE.get(k).getId()==lsVentas.get(i).getIdEmpleado())
                  ob[8] = lsE.get(k).getId();
           }
           ob[9] = lsVentas.get(i).getFormaPago().substring(0, 2);
            ...
            ob[1] = "";
            ob[2] = "";
            ob[3] = "$"+formateador.format(subtotal);
            ob[4] = "$"+formateador.format(descuento);
            ob[5] = "$"+formateador.format(iva);
            ob[6] = "$"+formateador.format(total);
            ob[7] = "$"+formateador.format(saldo);
            ob[8] = "";
            ob[9] = "";
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(23, 23, 23)
                .addComponent(Titulo, javax.swing.GroupLayout.PREFERRED_SIZE, 601, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        TableLista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha", "Folio", "Cliente", "Subtotal", "Descuento", "IVA", "Total", "Saldo", "E", "Fpa"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false, false, false, false, false
        ...
        if (TableLista.getColumnModel().getColumnCount() > 0) {
            ...
            TableLista.getColumnModel().getColumn(1).setPreferredWidth(15);
            ...
            TableLista.getColumnModel().getColumn(6).setPreferredWidth(25);
            TableLista.getColumnModel().getColumn(7).setPreferredWidth(25);
