 ...
 * @author Jonathan Gil
 */
public class vistaReportesProductos extends javax.swing.JDialog {
    ...
    public vistaReportesProductos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void listarPorPeriodoDeFecha() {
        ...
        List<Producto> lsVentas = productoDao.listarProductos();
    ...
    public void vaciarATabla(List<Producto> lsVentas) {
        ...
        for (int i = lsVentas.size() - 1; i >= 0; i--) {//las vaciamos de la mas reciente a la mas vieja
            ...
            if (lsVentas.get(i).getInventario() == 1) {
                ob[7] = "SI";
                ob[8] = formato.format(lsVentas.get(i).getExistencia());
            } else {
                ob[7] = "NO";
                ob[8] = "-";
            }
    ...
    private void initComponents() {
        ...
        TableLista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descripción", "Costo", "Depto", "Linea", "Precio", "Unidad", "Inv", "Exist"
            }
        ) {
        ...
        if (TableLista.getColumnModel().getColumnCount() > 0) {
            ...
            TableLista.getColumnModel().getColumn(7).setPreferredWidth(5);
            TableLista.getColumnModel().getColumn(8).setPreferredWidth(15);
        }
    ...
    private void btnNuevoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNuevoMouseClicked
        ...
        try {
            reporte.reportePDFSinTotal("Productos", TableLista, fecha, fecha, "\nREPORTE DE PRODUCTOS\n" + "RESUMEN" + "\nFECHA DE EMISION " + DiagHoy);
        } catch (DocumentException ex) {
            Logger.getLogger(vistaReportesProductos.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        reporte.reporteExcelSinTotales("Productos", TableLista);
        Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Generando reporte");
        panel.showNotification();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaReportesProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vistaReportesProductos dialog = new vistaReportesProductos(new javax.swing.JFrame(), true);
