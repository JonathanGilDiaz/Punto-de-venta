...
public class VistaPerfil extends javax.swing.JDialog {
    ...
    public VistaPerfil(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
       this.setLocation(200, 50);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        this.setTitle("Punto de venta - Perfiles");
        Seticon();
        TablePerfil.setBackground(Color.WHITE);
        ...
        TablePerfil.getColumnModel().getColumn(0).setCellRenderer(tcr);
        TablePerfil.getColumnModel().getColumn(1).setCellRenderer(tcr);
        TablePerfil.getColumnModel().getColumn(2).setCellRenderer(tcr);
        TablePerfil.getColumnModel().getColumn(3).setCellRenderer(tcr);
        TablePerfil.getColumnModel().getColumn(4).setCellRenderer(tcr);
        ((DefaultTableCellRenderer) TablePerfil.getTableHeader().getDefaultRenderer())
    ...
    public void listarPerfiles() {
        List<Perfil> ListaCl = perfilDao.listarPerfiles();
        modelo = (DefaultTableModel) TablePerfil.getModel();
        Object[] ob = new Object[6];
        for (int i = 0; i < ListaCl.size(); i++) {
            ob[0] = ListaCl.get(i).getId();
            ob[1] = ListaCl.get(i).getNombre();
            ob[2] = ListaCl.get(i).getDescripcion();
            ob[3] = fechaCorrecto(ListaCl.get(i).getFecha());
        ...
        TablePerfil.setModel(modelo);
    }
    
    public String fechaCorrecto(String fecha){
        ...
        public void eventoF4(){
            if(fila!=-1){                
               boolean tieneNotas=empleadoDao.perfilUsado(Integer.parseInt(TablePerfil.getValueAt(fila, 0).toString()));       
               if(tieneNotas==false){//si se va a eliminar
                   ...
                   if(cc.contraseñaAceptada==true){
                       bitacora.registrarRegistro("Se eliminó Perfil "+TablePerfil.getValueAt(fila, 1).toString(),cc.idEmpleado,fecha);
                       perfilDao.EliminarPerfil(Integer.parseInt(TablePerfil.getValueAt(fila, 0).toString()));
                        Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Perfil eliminado exitosamente");
            ...
            panelEstado.setBackground(new Color(179,195,219));
             ...
             fila=-1;
                 ...
                 Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.WARNING, Notification.Location.TOP_CENTER, "Ya se encuentra usando el perfil");
                                 panel.showNotification();
               }
            }else{
        ...
        public void eventoF3(){
            ...
            cc.setVisible(true);
            if(cc.contraseñaAceptada==true){
                Perfil aCambiar = perfilDao.BuscarPorCodigo(Integer.parseInt(TablePerfil.getValueAt(fila, 0).toString()));
                if(aCambiar.getEstado()==1){
                    perfilDao.ModificarEstado(Integer.parseInt(TablePerfil.getValueAt(fila, 0).toString()), 0);
                    bitacora.registrarRegistro("Estado de Perfil "+TablePerfil.getValueAt(fila, 1).toString()+": deshabilitado",cc.idEmpleado,fecha);
                    Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Perfil deshabilitado");
                                 panel.showNotification();
                }else{
                    perfilDao.ModificarEstado(Integer.parseInt(TablePerfil.getValueAt(fila, 0).toString()), 1);
                    bitacora.registrarRegistro("Estado de Perfil "+TablePerfil.getValueAt(fila, 1).toString()+": habilitado",cc.idEmpleado,fecha);
                    Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Perfil habilitado");
                                 panel.showNotification();
                }
                LimpiarTabla();
                listarPerfiles();
        ...
        public void eventoF2(){
            if(fila!=-1){
                 crearModificarPerfil cc = new crearModificarPerfil(new javax.swing.JFrame(), true);
                                                   cc.vaciarEmpleado(e.getId());
            List<Perfil> ls = perfilDao.listarPerfiles();
            for(int i=0;i<ls.size();i++){
                if(ls.get(i).getId()==Integer.parseInt(TablePerfil.getValueAt(fila, 0).toString())){
                    cc.vaciarDatos(false, ls.get(i));
                cc.setVisible(true);
                if(cc.accionCompletada==true){
                   Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "perfil modificado exitosamente");
                                 panel.showNotification();
                LimpiarTabla();
                listarPerfiles();
                    panelModificar.setBackground(new Color(179,195,219));
        ...
        public void eventoF1(){
             crearModificarPerfil cc = new crearModificarPerfil(new javax.swing.JFrame(), true);
                                               cc.vaciarEmpleado(e.getId());
        Perfil cp = new Perfil();
        cc.vaciarDatos(true, cp);
        cc.setVisible(true);
        if(cc.accionCompletada==true){        
            LimpiarTabla();
            listarPerfiles();
            ...
            panelEstado.setBackground(new Color(179,195,219));
             panelEliminar.setBackground(new Color(179,195,219));
             fila=-1;
             Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Perfil creado exitosamente");
                                 panel.showNotification();
        }
        }
    ...
    private void initComponents() {
        ...
        jTextField1.setLabelText("Buscar perfil");
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 105, 600, 60));

        jPanel4.setBackground(new java.awt.Color(255, 255, 255));
        jPanel4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel4.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        TablePerfil = new Table2();
        TablePerfil.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Código", "Nombre", "Descripción", "Fecha", "Creador por", "Estado"
            }
        ) {
        ...
        TablePerfil.setSelectionForeground(new java.awt.Color(0, 0, 0));
        TablePerfil.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TablePerfilMouseClicked(evt);
            }
        });
        TablePerfil.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TablePerfilKeyPressed(evt);
            }
        });
        jScrollPane8.setViewportView(TablePerfil);
        if (TablePerfil.getColumnModel().getColumnCount() > 0) {
            TablePerfil.getColumnModel().getColumn(0).setPreferredWidth(10);
            TablePerfil.getColumnModel().getColumn(1).setPreferredWidth(100);
            TablePerfil.getColumnModel().getColumn(2).setPreferredWidth(220);
            TablePerfil.getColumnModel().getColumn(3).setPreferredWidth(30);
            TablePerfil.getColumnModel().getColumn(4).setPreferredWidth(30);
            TablePerfil.getColumnModel().getColumn(5).setPreferredWidth(30);
        }
        ...
        btnNuevo.setToolTipText("F1 - Nuevo perfil");
        ...
        btnModificar.setToolTipText("F3 - Modificar perfil");
        ...
        btnEliminar.setToolTipText("F5 - Eliminar perfil");
    ...
    private void TablePerfilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablePerfilMouseClicked
        if (evt.getClickCount() == 2) {
            fila = TablePerfil.rowAtPoint(evt.getPoint());
    ...
    }//GEN-LAST:event_TablePerfilMouseClicked

    private void TablePerfilKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TablePerfilKeyPressed
    ...
    }//GEN-LAST:event_TablePerfilKeyPressed
    ...
    fila=-1;
        ...
        if(!"".equals(jTextField1.getText())){
            if(isNumeric(jTextField1.getText())==true){
                Perfil alistar = perfilDao.BuscarPorCodigo(Integer.parseInt(jTextField1.getText()));
                if(alistar.getId()==0){
                    modelo = (DefaultTableModel) TablePerfil.getModel();
                    TablePerfil.setModel(modelo);
                }else{
                    ...
                    Object[] ob = new Object[6];
                     ob[0] = alistar.getId();
                        ...
                        ob[3] = fechaCorrecto(alistar.getFecha());
                         Empleados e = empleadoDao.BuscarPorCodigo(alistar.getIdRecibe());
                    ob[4] = e.getNombre();    
                ...
                List<Perfil> lista = perfilDao.buscarLetra(jTextField1.getText());
                ...
                for (int i = 0; i < lista.size(); i++) {
                       ob[0] = lista.get(i).getId();
                        ...
                        ob[3] = fechaCorrecto(lista.get(i).getFecha());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VistaPerfil dialog = new VistaPerfil(new javax.swing.JFrame(), true);
