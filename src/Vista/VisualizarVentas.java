...
public class VisualizarVentas extends javax.swing.JDialog {
    ...
    public VisualizarVentas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void vaciarATabla(List<Ventas> lsVentas){
     ...
     public void eventoF2(){
          VisualizarNotasCredito vn = new VisualizarNotasCredito(new javax.swing.JFrame(), true);
                                  vn.vaciarEmpleado(e);
                                   vn.setLocation(150, 80);
                                   vn.setVisible(true);
     }
    ...
    private void initComponents() {
        ...
        btnNotaCredito = new javax.swing.JLabel();
        ...
        btnNotaCredito.setBackground(new java.awt.Color(255, 255, 255));
        btnNotaCredito.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 14)); // NOI18N
        btnNotaCredito.setForeground(new java.awt.Color(255, 255, 255));
        btnNotaCredito.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnNotaCredito.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Imagen4.png"))); // NOI18N
        btnNotaCredito.setToolTipText("F2 - Reporte");
        btnNotaCredito.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnNotaCredito.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnNotaCreditoMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnNotaCreditoMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnNotaCreditoMouseExited(evt);
            }
        });
        btnNotaCredito.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnNotaCreditoKeyPressed(evt);
            }
        });
        ...
        panelReporteLayout.setHorizontalGroup(
            ...
            .addComponent(btnNotaCredito, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
        );
        panelReporteLayout.setVerticalGroup(
            panelReporteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(btnNotaCredito, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
        );
    ...
    private void btnNotaCreditoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNotaCreditoMouseClicked
         eventoF2();
    }//GEN-LAST:event_btnNotaCreditoMouseClicked

    private void btnNotaCreditoMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNotaCreditoMouseEntered
        panelReporte.setBackground(new Color(153,204,255));
    }//GEN-LAST:event_btnNotaCreditoMouseEntered

    private void btnNotaCreditoMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNotaCreditoMouseExited
        panelReporte.setBackground(new Color(255,255,255));
    }//GEN-LAST:event_btnNotaCreditoMouseExited

    private void btnNotaCreditoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnNotaCreditoKeyPressed
          int codigo=evt.getKeyCode();
        switch(codigo){
            case KeyEvent.VK_F1:
            eventoF1();
    ...
    }//GEN-LAST:event_btnNotaCreditoKeyPressed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VisualizarVentas dialog = new VisualizarVentas(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JLabel btnNotaCredito;
