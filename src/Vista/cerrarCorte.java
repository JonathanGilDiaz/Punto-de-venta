 ...
 * @author Jonathan Gil
 */
public class cerrarCorte extends javax.swing.JDialog {
    ...
    public cerrarCorte(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         this.setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        Seticon();
         this.setTitle("Punto de venta - Cerrar corte");
         ...
         txtSaldoCaja.setBackground(new Color(240,240,240));
         txtGanancias.setBackground(new Color(240,240,240));
         txtSaldoFina.setBackground(new Color(240,240,240));


    }   
    
    public void vaciarDatos(double saldoCaja, double ganancia){
        this.saldoCaja=saldoCaja;
        txtSaldoCaja.setText("$"+formateador.format(saldoCaja));
        txtGanancias.setText("$"+formateador.format(ganancia));
    }
    
   
     public void eventoEnter(){
             if(!"".equals(txtSaldoFina.getText())){
                ...
                cc.vaciarEmpleado(empleado.getId());
                   ...
                   if(cc.contraseñaAceptada==true){
                    if(Double.parseDouble(txtRetiro.getText())<saldoCaja){
                        retiro = Double.parseDouble(txtRetiro.getText());
                        saldoFinal = saldoCaja-retiro;
                        observacion = txtObservaciones.getText();
                         accionRealizada=true;
                         dispose();
                    }else{
                 Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.WARNING, Notification.Location.TOP_CENTER, "El retiro es mayor a Saldo en caja");
                 ...
                 Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.WARNING, Notification.Location.TOP_CENTER, "Debe introducir una cantidad valida");
                                 panel.showNotification();
             }
    ...
    private void initComponents() {
        ...
        txtSaldoFina = new javax.swing.JTextField();
        ...
        jPanel4.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 250, 20));
        ...
        jPanel4.add(panelCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 50, 50));
        ...
        jPanel4.add(panelGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, 50, 50));

        lbNombre2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        lbNombre2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbNombre2.setText("Saldo en caja");
        jPanel4.add(lbNombre2, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 40, 90, -1));

        lbNombre.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        lbNombre.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbNombre.setText("Retiro");
        jPanel4.add(lbNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 70, 90, -1));

        lbNombre4.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        lbNombre4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbNombre4.setText("Saldo final");
        jPanel4.add(lbNombre4, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 100, 90, -1));

        txtSaldoFina.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        txtSaldoFina.setToolTipText("Saldo final en caja");
        txtSaldoFina.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtSaldoFina.setEnabled(false);
        txtSaldoFina.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtSaldoFinaKeyReleased(evt);
            }
        });
        jPanel4.add(txtSaldoFina, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 160, -1));

        txtRetiro.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        txtRetiro.setToolTipText("Cantidad a retirar");
        ...
        jPanel4.add(txtRetiro, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 70, 160, -1));

        txtSaldoCaja.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        ...
        jPanel4.add(txtSaldoCaja, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, 160, -1));

        txtObservaciones.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        txtObservaciones.setToolTipText("Observaciones del corte");
        txtObservaciones.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtObservacionesKeyReleased(evt);
            }
        });
        jPanel4.add(txtObservaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, 160, -1));
        ...
        jPanel4.add(lbNombre5, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 133, 90, -1));

        lbNombre6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        lbNombre6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbNombre6.setText("Ganancias");
        jPanel4.add(lbNombre6, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 163, 90, -1));

        txtGanancias.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        txtGanancias.setToolTipText("Ganancias del día");
        txtGanancias.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtGanancias.setEnabled(false);
        txtGanancias.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtGananciasKeyReleased(evt);
            }
        });
        jPanel4.add(txtGanancias, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 160, 160, -1));
    ...
    private void txtSaldoFinaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSaldoFinaKeyReleased
        int codigo=evt.getKeyCode();
        switch(codigo){
            case KeyEvent.VK_ENTER:
            eventoEnter();
    ...
    }//GEN-LAST:event_txtSaldoFinaKeyReleased
    ...
    private void txtRetiroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRetiroKeyReleased
        ...
        if(!"".equals(txtRetiro.getText())){
            if(!txtRetiro.getText().endsWith(".")){
                ...
                txtSaldoFina.setText("$"+formateador.format(saldoCaja-cantidad));
            } else txtSaldoFina.setText("");
        }else txtSaldoFina.setText("");
    ...
    private void txtGananciasKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtGananciasKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_txtGananciasKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cerrarCorte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                cerrarCorte dialog = new cerrarCorte(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField txtSaldoFina;
